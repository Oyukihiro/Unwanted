    ...
    async def get_track_info(self, url: str, user: disnake.Member = None, loop = None):
        ...
        for e in self.extractors:
            ...
            if e["age_limit"] > 17 and e["ie_key"] != "Twitter":
                raise GenericError("**This link contains content for adults over 18 years of age!**")
            ...
            try:
                if data["_type"] == "playlist":
                    raise GenericError("**Currently, playlists with the provided link are not supported...**")
            except KeyError:
                pass
...
if __name__ == "__main__":
    ...
    ydl = YTDLTools()
    url = "https://www.youtube.com/@unwanted_arc"
