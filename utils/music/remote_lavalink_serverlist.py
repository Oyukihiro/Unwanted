...
lavalink_urls = {
    "ssl": "https://raw.githubusercontent.com/DarrenOfficial/lavalink-list/refs/heads/master/docs/SSL/Lavalink-SSL.md",
    "non-ssl": "https://raw.githubusercontent.com/DarrenOfficial/lavalink-list/refs/heads/master/docs/NoSSL/Lavalink-NonSSL.md",
}
...
def get_lavalink_servers():
    ...
    print(f"Downloading lavalink server list from source: https://lavalink-list.darrennathanael.com/\n"
          "Note:Because these Lavalink servers are public, they may experience instability..")
